    ...
    input.addEventListener("focusout",function(){
        ...
        geocoder.geocode({address:this.value}, (result, status)=>{
            if (status=="OK"){
                ...
                console.log(res)
                pos = ({"Latitude":res.lat, "Longitude":res.lng})
                localStorage.pos=JSON.stringify(pos)
                document.getElementById("location").innerHTML = ('<img style="width:4%; margin-right: 1vw; margin-bottom: -0.2vh;"src="resources/location.png">')
...
function changeTheme(){
    ...
    if (theme == 1){
        ...
        document.getElementById("locationButton").setAttribute("src","./resources/locationButton-dark.png")
    }else if(theme == 2){
        ...
        document.getElementById("locationButton").setAttribute("src","./resources/locationButton-light.png")
    }else if(theme == 3){
...
function showLongTermData(data){
    ...
    document.getElementById("longTerm").innerHTML = ("")
    longTermData.forEach(function(day){
        ...
        if((String(tempMax)).length + (String(tempMin)).length > 3){
            tempHeading.setAttribute("style","font-size: 3.75vh")
            maxSpan.setAttribute("style","margin-right: -2.5vh")
            console.log((String(tempMax)).length + (String(tempMin)).length)
        }
